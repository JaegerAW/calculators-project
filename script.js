...
//turn clearDisplay into true with every operator function,
...
addBtn.addEventListener("click", () => {
  if (!operator) {
    //if operator doesnt exist, set firstNumber to display,operator to add, and next number input clears the display first.
